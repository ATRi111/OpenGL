...
bool ImGui::ButtonBehavior(const ImRect& bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags)
{
    ...
    ImGuiController* backup_hovered_window = g.HoveredWindow;
...
ImGuiID ImGui::GetWindowScrollbarID(ImGuiController* window, ImGuiAxis axis)
{
    return window->GetID(axis == ImGuiAxis_X ? "#SCROLLX" : "#SCROLLY");
}

// Return scrollbar rectangle, must only be called for corresponding axis if window->ScrollbarX/Y is set.
ImRect ImGui::GetWindowScrollbarRect(ImGuiController* window, ImGuiAxis axis)
{
...
bool ImGui::BeginComboPopup(ImGuiID popup_id, const ImRect& bb, ImGuiComboFlags flags)
{
    ...
    if (ImGuiController* popup_window = FindWindowByName(name))
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    ImGuiController* draw_window = window;
...
bool ImGui::ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags)
{
    ...
    ImGuiController* picker_active_window = NULL;
...
static void BoxSelectActivateDrag(ImGuiBoxSelectState* bs, ImGuiController* window)
{
    ImGuiContext& g = *GImGui;
...
static void BoxSelectScrollWithMouseDrag(ImGuiBoxSelectState* bs, ImGuiController* window, const ImRect& inner_r)
{
    ImGuiContext& g = *GImGui;
...
bool ImGui::BeginBoxSelect(const ImRect& scope_rect, ImGuiController* window, ImGuiID box_select_id, ImGuiMultiSelectFlags ms_flags)
{
    ImGuiContext& g = *GImGui;
    ImGuiBoxSelectState* bs = &g.BoxSelectState;
...
static ImRect CalcScopeRect(ImGuiMultiSelectTempData* ms, ImGuiController* window)
{
    ImGuiContext& g = *GImGui;
...
void ImGui::EndMenuBar()
{
    ...
    if (NavMoveRequestButNoResultYet() && (g.NavMoveDir == ImGuiDir_Left || g.NavMoveDir == ImGuiDir_Right) && (g.NavWindow->Flags & ImGuiWindowFlags_ChildMenu))
    {
        ...
        ImGuiController* nav_earliest_child = g.NavWindow;
...
bool ImGui::BeginViewportSideBar(const char* name, ImGuiViewport* viewport_p, ImGuiDir dir, float axis_size, ImGuiWindowFlags window_flags)
{
    ...
    ImGuiController* bar_window = FindWindowByName(name);
...
bool ImGui::BeginMenuEx(const char* label, const char* icon, bool enabled)
{
    ...
    if (window->DC.LayoutType == ImGuiLayoutType_Vertical) // (window->Flags & (ImGuiWindowFlags_Popup|ImGuiWindowFlags_ChildMenu))
    {
        ...
        ImGuiController* child_menu_window = (child_popup && child_popup->Window && child_popup->Window->ParentWindow == window) ? child_popup->Window : NULL;
...
void ImGui::EndMenu()
{
    ...
    ImGuiController* parent_window = window->ParentWindow;  // Should always be != NULL is we passed assert.
...
namespace ImGui
{
    ...
    static ImU32            TabBarCalcTabID(ImGuiTabBar* tab_bar, const char* label, ImGuiController* docked_window);
...
static ImU32   ImGui::TabBarCalcTabID(ImGuiTabBar* tab_bar, const char* label, ImGuiController* docked_window)
{
...
bool    ImGui::TabItemEx(ImGuiTabBar* tab_bar, const char* label, bool* p_open, ImGuiTabItemFlags flags, ImGuiController* docked_window)
{
...
ImVec2 ImGui::TabItemCalcSize(ImGuiController*)
{
