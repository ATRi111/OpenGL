...
// Helper
inline ImGuiTableFlags TableFixFlags(ImGuiTableFlags flags, ImGuiController* outer_window)
{
...
{
    ImGuiContext& g = *GImGui;
    ImGuiController* outer_window = GetCurrentWindow();
    ...
    ImGuiController* inner_window = table->InnerWindow;
...
void    ImGui::EndTable()
{
    ...
    ImGuiController* inner_window = table->InnerWindow;
    ImGuiController* outer_window = table->OuterWindow;
...
{
    ImGuiController* window = table->InnerWindow;
...
void ImGui::SetWindowClipRectBeforeSetChannel(ImGuiController* window, const ImRect& clip_rect)
{
...
ImGuiOldColumns* ImGui::FindOrCreateColumns(ImGuiController* window, ImGuiID id)
{
